...
var _BVHBranch = require('./BVHBranch');

var _BVHBranch2 = _interopRequireDefault(_BVHBranch);
...
class BVH {
		...
		if (!current) {
			...
			while (true) {
				...
				// Leaf
						...
						const new_parent = current._bvh_parent = body._bvh_parent = _BVHBranch2.default.getBranch();
  ...
  */
	remove(body, updating = false) {
		...
		_BVHBranch2.default.releaseBranch(parent);
	}
